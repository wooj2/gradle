...
/**
 * Allows declaring repositories in a central fashion inside {@link DependencyResolutionManagement} in {@link org.gradle.api.initialization.Settings}.
 *
 * @since 6.8.1
 */
@Incubating
public interface CentralRepositoryHandler {
     ...
     * are specified.
     */
    CentralRepositoryHandler flatDir(Map<String, ?> args);
     ...
     */
    CentralRepositoryHandler flatDir(Action<? super FlatDirectoryArtifactRepository> action);
     ...
     */
    CentralRepositoryHandler gradlePluginPortal();
     ...
     * @return the added resolver
     */
    CentralRepositoryHandler gradlePluginPortal(Action<? super ArtifactRepository> action);
     ...
     */
    CentralRepositoryHandler jcenter(Action<? super MavenArtifactRepository> action);
     ...
     * @see #jcenter(Action)
     */
    CentralRepositoryHandler jcenter();
     ...
     * @return the added repository
     */
    CentralRepositoryHandler mavenCentral(Map<String, ?> args);
     ...
     */
    CentralRepositoryHandler mavenCentral();
     ...
     * @return the added resolver
     */
    CentralRepositoryHandler mavenCentral(Action<? super MavenArtifactRepository> action);
     ...
     * @return the added resolver
     */
    CentralRepositoryHandler mavenLocal();
     ...
     * @return the added resolver
     */
    CentralRepositoryHandler mavenLocal(Action<? super MavenArtifactRepository> action);
     ...
     * @return the added resolver
     */
    CentralRepositoryHandler google();
     ...
     * @return the added resolver
     */
    CentralRepositoryHandler google(Action<? super MavenArtifactRepository> action);
     ...
     * @return The added repository.
     */
    CentralRepositoryHandler maven(Action<? super MavenArtifactRepository> action);
     ...
     * @return The added repository.
     */
    CentralRepositoryHandler ivy(Action<? super IvyArtifactRepository> action);
     ...
     */
    CentralRepositoryHandler exclusiveContent(Action<? super ExclusiveContentRepository> action);
}
