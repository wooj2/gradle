...
import org.gradle.api.initialization.resolve.CentralRepositoryHandler;
...
public class DefaultDependencyResolutionManagement implements DependencyResolutionManagementInternal {
    ...
    private final RepositoriesRegistrar repositoriesRegistrar = new RepositoriesRegistrar();
    ...
    @Override
    public CentralRepositoryHandler getRepositories() {
    ...
    private class RepositoriesRegistrar implements CentralRepositoryHandler {

        @Override
        public CentralRepositoryHandler flatDir(Map<String, ?> args) {
            repositories(h -> h.flatDir(args));
            return this;
        }

        @Override
        public CentralRepositoryHandler flatDir(Action<? super FlatDirectoryArtifactRepository> action) {
            repositories(h -> h.flatDir(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler gradlePluginPortal() {
            repositories(RepositoryHandler::gradlePluginPortal);
            return this;
        }

        @Override
        public CentralRepositoryHandler gradlePluginPortal(Action<? super ArtifactRepository> action) {
            repositories(h -> h.gradlePluginPortal(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler jcenter(Action<? super MavenArtifactRepository> action) {
            repositories(h -> h.jcenter(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler jcenter() {
            repositories(RepositoryHandler::jcenter);
            return this;
        }

        @Override
        public CentralRepositoryHandler mavenCentral(Map<String, ?> args) {
            repositories(h -> h.mavenCentral(args));
            return this;
        }

        @Override
        public CentralRepositoryHandler mavenCentral() {
            repositories(RepositoryHandler::mavenCentral);
            return this;
        }

        @Override
        public CentralRepositoryHandler mavenCentral(Action<? super MavenArtifactRepository> action) {
            repositories(h -> h.mavenCentral(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler mavenLocal() {
            repositories(RepositoryHandler::mavenLocal);
            return this;
        }

        @Override
        public CentralRepositoryHandler mavenLocal(Action<? super MavenArtifactRepository> action) {
            repositories(h -> h.mavenLocal(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler google() {
            repositories(RepositoryHandler::google);
            return this;
        }

        @Override
        public CentralRepositoryHandler google(Action<? super MavenArtifactRepository> action) {
            repositories(h -> h.google(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler maven(Action<? super MavenArtifactRepository> action) {
            repositories(h -> h.maven(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler ivy(Action<? super IvyArtifactRepository> action) {
            repositories(h -> h.ivy(action));
            return this;
        }

        @Override
        public CentralRepositoryHandler exclusiveContent(Action<? super ExclusiveContentRepository> action) {
